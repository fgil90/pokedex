<template>
    <header id="myHeader">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark ml-auto">
            <a class="navbar-brand" href="#" style="font-family: 'Pokemon Hollow'; font-size: 25px;"><img src="../assets/Pokemon-logo.svg" width="160" style="margin: 0; padding:0;"></a>
                    ...
                    <form class="form-inline m-auto">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <span class="input-group-text" id="basic-addon2"><img src="../assets/icon-search.svg" height="20"></span>
                            </div>
                        </div>
                    </form>
                </div>
